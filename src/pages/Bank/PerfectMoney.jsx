                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                        ...
                        <h1 className="text-5xl font-bold text-slate-900 dark:text-white mb-6">
                            Buy <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-emerald-600">Verified Perfect Money Accounts</span>
                        </h1>
                        <p className="text-lg text-slate-600 dark:text-slate-300 mb-8">
                            100% Verified PerfectMoney accounts with full access. Instant delivery, high balance ready accounts available.
                        </p>
                    ...
                    <div className="relative">
                        <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-xl">
                            <div className="h-80 bg-gradient-to-br from-green-400 to-emerald-600 rounded-2xl flex items-center justify-center">
                                <span className="text-6xl font-bold text-white drop-shadow-lg">PerfectMoney</span>
                            </div>
                        </div>
                    </div>
                </div>
